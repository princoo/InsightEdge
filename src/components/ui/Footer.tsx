...
export default function Footer() {
  return (
    <footer className="bg-gray dark:bg-secondary border-t border-gray-200 dark:border-gray/20">
      <div className="mx-auto max-w-screen-xl px-4 pt-16 pb-6 sm:px-6 lg:px-8 lg:pt-24">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            ...
            <p className="mt-6 max-w-md text-center leading-relaxed text-secondary-text dark:text-white sm:max-w-xs sm:text-left">
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2">
            <div className="text-center sm:text-left">
              ...
              <ul className="mt-8 space-y-4 text-sm">
                {footerListItems[0].quickLinks.map((item) => (
                  <li key={item.label}>
                    <Link
                      className="text-secondary-text hover:text-secondary-text/75 dark:text-white"
                      href={item.href}
                    >
                      {item.label}
                    </Link>
            ...
            <div className="text-center sm:text-left text-black dark:text-white">
        ...
        <div className="mt-12 border-t border-gray pt-6">
